...
def train_nn_regression_mode(learning_rate,
                             steps,
                             batch_size,
                             hidden_units,
                             training_examples,
...
dnn_regressor = train_nn_regression_mode(0.001,2000,100,[10,10],training_examples,training_targets,validation_examples,validation_targets)
